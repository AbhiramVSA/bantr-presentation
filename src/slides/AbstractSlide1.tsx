...
const points = [
  'Bantr is an AI-powered platform that enables real-time voice debates between humans and configurable AI agents.',
  'Users create AI debate opponents with custom personalities, debate styles, tone constraints, and argumentation strategies.',
  'The system integrates Speech-to-Text (Deepgram Nova-2) for real-time voice transcription with sub-300ms latency.',
  'Large Language Models (GPT-4 Turbo / Claude 3.5) generate dynamic counter-arguments, structured rebuttals, and adversarial reasoning in real time.',
  'Text-to-Speech (ElevenLabs Turbo v2) converts AI responses to natural, expressive voice output — achieving sub-2s end-to-end pipeline latency.',
];

export default function AbstractSlide1() {
  return (
    <div className="relative w-full h-full overflow-hidden bg-black">
      ...
      <div className="relative z-10 flex flex-col w-full h-full" style={{ padding: '4% 5.2%' }}>
        ...
        <div className="flex items-center justify-end w-full" style={{ marginTop: '1.5%' }}>
          <span style={{ fontSize: 'clamp(12px, 1.05vw, 20px)', opacity: 0.6 }}>Abstract (1/2)</span>
        </div>
      </div>
    </div>
  );
